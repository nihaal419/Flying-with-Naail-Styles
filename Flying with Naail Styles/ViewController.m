...
-(void)Collision
{
    ...
    if (CGRectIntersectsRect(Heli.frame, Bottom8.frame))
    {
        [self EndGame];
    }
    ...
    if (CGRectIntersectsRect(Heli.frame, Top8.frame))
    {
        [self EndGame];
    }
    
    if (Heli.center.y > 260)
    {
        [self EndGame];
    }
...
-(void)NewGame
{
    ...
    Heli.hidden = NO;
    Heli.center = CGPointMake(69, 144);
    Heli.image = [UIImage imageNamed:@"Helicopter - Up.png"];
...
-(void)HeliMove
{
    ...
    {
        RandomPosition = arc4random() %55;
        Top8.center = CGPointMake(510, RandomPosition);
        RandomPosition = RandomPosition + 265;
        Bottom8.center = CGPointMake(510, RandomPosition);
    }
}
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    if (Start == YES)
    {
        ...
        RandomPosition = arc4random() %55;
        Top8.center = CGPointMake(1120, RandomPosition);
        RandomPosition = RandomPosition + 265;
        Bottom8.center = CGPointMake(1120, RandomPosition);
    }
...
{
    Y = 7;
    Heli.image = [UIImage imageNamed:@"Helicopter - Down.png"];
}
